...
import { ORG_NAME, SENSEI, LOCALIDADE } from "@dojo-fs/ui";

export const metadata: Metadata = {
  title: `Contato · ${ORG_NAME}`,
  description: `Fale com Sensei ${SENSEI}. WhatsApp direto, Instagram, YouTube. Agende aula experimental gratuita no ${ORG_NAME} — ${LOCALIDADE}.`,
};
    ...
    <main className="min-h-screen bg-dojo-black pt-24 pb-24 sm:pt-32 sm:pb-32">
      <div className="mx-auto max-w-3xl px-6 sm:px-8 lg:px-12">
        ...
        <nav className="mb-8 text-xs uppercase tracking-[0.3em] text-dojo-white/40">
          ...
          <span className="text-dojo-white/60">Contato</span>
        </nav>
        ...
        <header className="mb-16 text-center">
          ...
          <p className="mx-auto mt-8 max-w-xl text-base leading-relaxed text-dojo-white/70 sm:text-lg">
            Resposta rápida pelo WhatsApp. Sensei {SENSEI} mesmo responde.
          </p>
        </header>
        ...
        <section className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-4 rounded-sm border border-dojo-white/10 bg-dojo-gray/5 p-6 transition-all hover:border-dojo-red"
          >
        ...
        {/* Privacidade */}
        <p className="mt-12 text-center text-xs uppercase tracking-widest text-dojo-white/30">
